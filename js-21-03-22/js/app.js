...
// if (data.length == 9 ) {
//   if (
//     // data.charCodeAt(0) == 88 || data.charCodeAt(0) == 84) {
//     // if (data.charCodeAt(data.length-1) >=65 &&
//     // data.charCodeAt(data.length-1) <=90
//     65 <= 
//     datadata.charCodeAt(data.length -1) <= 90
//      ) {
//        if (
...
//  var NIE = prompt("Introduzca su NIE");
//  if (
//   //  LETRAS DNI NUMERICO charCodeAt cambia numero por letras
